...
var UsersService = (function () {
    ...
    UsersService.prototype.create = function (createUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.usersRepository.save(user)];
            });
        });
    };
    UsersService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.usersRepository.findOne({ where: { id: id } })];
                    case 1:
                        user = _a.sent();
                        if (!user) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.usersRepository.update(id, updateUserDto)];
                    case 2:
                        _a.sent();
                        return [2, this.findOne(id)];
                }
            });
        });
    };
